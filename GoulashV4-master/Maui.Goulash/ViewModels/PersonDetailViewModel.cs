...
namespace MAUI.Goulash.ViewModels
{
    public class PersonDetailViewModel : INotifyPropertyChanged
    {
        ...
        /*public ObservableCollection<Course> StudentCourses
        {
            get
            {
                //solve later, a courses roster is only stored in the course class, students dont have a list as member data
            }
        }*/
        ...
        {
            //this.StudentCourses.Add(SelectedCourse); //"this" should be of type student/person
            //SelectedCourse.Roster.Add();
        }
